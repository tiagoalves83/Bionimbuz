...
public class LinuxGetInfo implements Callable<PluginInfo> {
     ...
     * informações na classe pluginInfo.
     * Número de cores, frequencia do processador(GHz) e quantidade de cores
     * ocupados.
     */
    private void getCpuInfo() {
        ...
        if (!SystemUtils.IS_OS_LINUX) {
            ...
            // Adding fake code to provide in the futere a support to others OSs
            cpuInfo = ":2400";
            // TODO: TEMP CODE - end
        }
    ...
    /**
     * Retorna o número de cores ocupados no recuso caso seu processamento
     * estaja acima de 70 porcento.
     * 
     ...
     * informações na classe pluginInfo.
     * Memória total e memória livre em GigaBytes(Retorno da eexcução em KB /
     * 1024²).
     */
    ...
    /**
     * Obtem as informações do espaço e, disco do recurso e realiza o setter
     * dessa informações na classe pluginInfo.
